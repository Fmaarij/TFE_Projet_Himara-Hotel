...
Route::delete('/{id}/delroomnotvalidated',[RoomController::class,'delroomnotvalidated'])->middleware(['auth', 'roleeditor']);
Route::delete('/{id}/delroomnotvalidated',[RoomController::class,'deleterom'])->middleware(['auth', 'roleeditor']);
